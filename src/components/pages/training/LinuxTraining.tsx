...
interface LinuxTrainingProps {
  onNavigate: (page: string) => void;
}

export function LinuxTraining({ onNavigate }: LinuxTrainingProps) {
  const [openModule, setOpenModule] = useState<number | null>(null);

  const highlights = [
    { icon: Target, text: 'Production-ready Linux skills' },
    { icon: Laptop, text: 'Real-world server administration' },
    { icon: Users, text: 'Expert Linux system administrators' },
    { icon: Zap, text: 'Live command-line practice' },
    { icon: Award, text: 'Industry-focused training' },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#00B871]/30 mb-6">
              <Terminal className="w-5 h-5 text-[#00B871]" />
              <span className="text-[#00D67E] text-sm">Hands-On | Production-Ready | Career-Focused</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl mb-4 text-white">
              Linux System Administration <span className="text-[#00B871] text-glow">Training</span>
            </h1>
            <div className="h-1 w-32 bg-gradient-to-r from-[#00B871] to-[#00D67E] mx-auto mb-6"></div>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto">
              Master Linux command line, shell scripting, and server management. Essential skills for cybersecurity 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white">6-8 weeks</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
