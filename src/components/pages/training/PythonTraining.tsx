...
interface PythonTrainingProps {
  onNavigate: (page: string) => void;
}

export function PythonTraining({ onNavigate }: PythonTrainingProps) {
  const [openModule, setOpenModule] = useState<number | null>(null);

  const highlights = [
    { icon: Target, text: 'Security-focused Python programming' },
    { icon: Laptop, text: 'Build real security tools' },
    { icon: Users, text: 'Expert Python developers' },
    { icon: Zap, text: 'Live coding sessions' },
    { icon: Award, text: 'Industry-oriented training' },
  ];
  ...
  const modules = [
    ...
    },
    {
      ...
      topics: [
        ...
        'TCP/UDP Network Communications',
    ...
    },
    {
      ...
      icon: Lock,
      topics: [
        'Port Scanners & Network Tools',
        'Password Crackers & Hash Tools',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-[#00B871]/30 mb-6">
              <Code className="w-5 h-5 text-[#00B871]" />
              <span className="text-[#00D67E] text-sm">Security-Focused | Hands-On | Career-Ready</span>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl mb-4 text-white">
              Python for Cybersecurity <span className="text-[#00B871] text-glow">Training</span>
            </h1>
            <div className="h-1 w-32 bg-gradient-to-r from-[#00B871] to-[#00D67E] mx-auto mb-6"></div>
            <p className="text-lg text-gray-400 max-w-4xl mx-auto">
              Learn Python programming with a focus on cybersecurity applications. Build security tools and automate 
              security tasks like a professional.
            </p>
          </motion.div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white">8 weeks</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
